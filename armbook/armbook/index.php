...
<input type="hidden" id="session_id" name="ARM_SESSION" value="<?php if(!isset($_COOKIE["ARM_SESSION"])){echo substr(md5(time()),0,22);}else{echo htmlentities($_COOKIE["ARM_SESSION"]);} ?>" />
</td><td>
